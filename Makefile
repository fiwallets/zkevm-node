...
LDFLAGS += -X 'github.com/fiwallets/zkevm-node.Version=$(VERSION)'
LDFLAGS += -X 'github.com/fiwallets/zkevm-node.GitRev=$(GITREV)'
LDFLAGS += -X 'github.com/fiwallets/zkevm-node.GitBranch=$(GITBRANCH)'
LDFLAGS += -X 'github.com/fiwallets/zkevm-node.BuildDate=$(DATE)'
