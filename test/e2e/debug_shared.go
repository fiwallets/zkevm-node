...
import (
	...
	"github.com/fiwallets/zkevm-node/test/contracts/bin/BridgeA"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/BridgeB"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/BridgeC"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/BridgeD"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/Called"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/Caller"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/ChainCallLevel1"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/ChainCallLevel2"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/ChainCallLevel3"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/ChainCallLevel4"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/Counter"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/Creates"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/Depth"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/ERC20"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/EmitLog"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/Log0"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/Memory"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/OpCallAux"
	"github.com/fiwallets/zkevm-node/test/contracts/bin/Revert2"
...
func saveTraceResultToFile(t *testing.T, name, network string, signedTx *ethTypes.Transaction, trace json.RawMessage, skip bool) {
	...
	const path = "/Users/thiago/github.com/fiwallets/zkevm-node/dist/%v.json"
